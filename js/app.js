...
class Spotlight extends HTMLElement{
    ...
    connectedCallback(){
        ...
        this.items = Array.from(document.querySelectorAll(this.getAttribute('target'))).map
        (a => {
        ...
        //Ecoute du raccourcis clavier
        window.addEventListener('keydown', this.shortcutHandler)
        window.addEventListener('input', this.OnInput)
        window.addEventListener('keydown', this.inputShortcutHandler)
    }
